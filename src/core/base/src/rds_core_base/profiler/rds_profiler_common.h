...
#pragma mark --- rds_profiler_marco-Impl ---
	...
	#define RDS_PROFILE_TRANSIENT_SCOPED()			NMSP_PROFILE_TRANSIENT_SCOPED()
	#define RDS_PROFILE_TRANSIENT_SECTION(NAME)		NMSP_PROFILE_TRANSIENT_SECTION(NAME)
	#define RDS_PROFILE_TRANSIENT_FMT(FMT, ...)		NMSP_PROFILE_TRANSIENT_SECTION(fmtAs_T<TempString>(FMT, __VA_ARGS__).c_str())
	...
	#define RDS_PROFILE_TRANSIENT_SCOPED()			
	#define RDS_PROFILE_TRANSIENT_SECTION(NAME)		
