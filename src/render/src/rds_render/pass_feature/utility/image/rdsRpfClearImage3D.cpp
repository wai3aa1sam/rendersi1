...
{
	RenderUtil::createShader(RDS_DebugLabel(), &_shaderClearImage3D, "asset/shader/pass_feature/utility/image/rdsClearImage3D.shader");
}
...
{
	RenderUtil::createMaterial(RDS_DebugLabel(), _shaderClearImage3D, &mtl_);
