...
#define RDS_PROFILE_GPU_CREATE_CTX_VK_IMPL(PHY_DEV, DEV, QUEUE, CMDBUF)		nullptr									
#define RDS_PROFILE_GPU_CREATE_CTX_CALIBRATED_VK_IMPL(PHY_DEV, DEV, QUEUE, CMDBUF, FUNC_EXT_CTD, FUNC_EXT_CT)	nullptr
#define RDS_PROFILE_GPU_DESTROY_CTX_VK_IMPL(T_GP_CTX)															

#define RDS_PROFILE_GPU_CTX_NAME_VK_IMPL(T_GP_CTX, NAME)	

#define RDS_PROFILE_GPU_ZONET_VK_IMPL(T_GP_CTX, CMDBUF, NAME)	
#define RDS_PROFILE_GPU_COLLECT_VK_IMPL(T_GP_CTX, CMDBUF)	

// ---
#define RDS_PROFILE_GPU_CTX_VK(VAR_NAME)			
#define RDS_PROFILE_GPU_CTX_CREATE(GP_CTX, NAME)	
#define RDS_PROFILE_GPU_CTX_DESTROY(GP_CTX)			

#define RDS_PROFILE_GPU_CTX_SET_NAME(NAME)	

#define  RDS_PROFILE_GPU_ZONE_VK(GP_CTX, CMDBUF, NAME)			
#define RDS_PROFILE_GPU_ZONEC_VK(GP_CTX, CMDBUF, NAME, COLOR)	
#define RDS_PROFILE_GPU_ZONET_VK(GP_CTX, CMDBUF, NAME)			
#define RDS_PROFILE_GPU_COLLECT_VK(GP_CTX, CMDBUF)				

using TracyVkCtx = int*;
