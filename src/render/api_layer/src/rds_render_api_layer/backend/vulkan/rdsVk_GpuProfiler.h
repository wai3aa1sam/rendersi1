...
#include "rds_render_api_layer/profiler/rdsGpuProfiler.h"
...
#define RDS_VK_PROFILE_GPU_SECTION(		PROFILER, CMDBUF, SRCLOC_DATA)	auto RDS_VAR_NAME(_scope) = PROFILER.makeProfileScope(SRCLOC_DATA, CMDBUF)
...
public:
	...
	RDS_NODISCARD VkProfileScope makeProfileScope(const SrcLocData* srcLocData, Vk_CommandBuffer* vkCmdBuf);
