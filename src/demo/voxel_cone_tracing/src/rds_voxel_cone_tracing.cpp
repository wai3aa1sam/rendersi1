...
VoxelConeTracing::onCreateScene(Scene* oScene)			
{
	...
	auto shader = RDS_TEST_SHADOW ? Renderer::renderDevice()->createShader(RDS_DebugLabel(), "asset/shader/lighting/rdsDefaultLighting.shader") : _rpfVct->getVoxelizationShader();
