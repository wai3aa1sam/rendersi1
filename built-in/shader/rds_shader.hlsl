#ifndef __rds_shader_HLSL__
#define __rds_shader_HLSL__

#include "rds_shader-config.hlsl"
...
#include "built-in/shader/common/rdsSample_Common.hlsl"

#include "built-in/shader/lighting/rds_lighting.hlsl"

#include "built-in/shader/post_processing/rdsColor.hlsl"
